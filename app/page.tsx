...
export default function ATMO_Hub() {
  return (
    <>
      {/* BALISES SEO INVISIBLES POUR LE SITE VITRINE */}
      <title>ATMO | Éditeur de logiciels de Chauffage, Ventilation et Climatisation</title>
      <meta name="description" content="Découvrez ATMO et GainablePro, le logiciel de chiffrage de gainable de référence pour les professionnels. Optimisez vos réseaux aérauliques en quelques clics." />
      ...
      <div className="min-h-screen bg-[#F8FAFC] flex flex-col font-sans">
        ...
        <section className="bg-[#0E3A5F] text-white pt-24 pb-24 px-6 relative overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto text-center relative z-10">
            ...
            <p className="text-lg md:text-xl text-blue-100 font-medium max-w-2xl mx-auto leading-relaxed">
              ATMO conçoit des outils digitaux de pointe pour les professionnels du Chauffage, de la Ventilation et de la Climatisation. 
        ...
        <section className="bg-white py-24 px-6 border-b border-gray-100">
          <div className="max-w-7xl mx-auto">
            <div className="max-w-3xl mx-auto text-center mb-16">
              <h2 className="text-[#29A5DB] font-black text-[11px] uppercase tracking-[0.2em] mb-4">L'Expertise ATMO</h2>
              <h3 className="text-3xl md:text-4xl font-black text-[#0E3A5F] mb-6 tracking-tight">
                Digitaliser le secteur du Chauffage, de la Ventilation et de la Climatisation
              </h3>
        ...
        <main className="max-w-7xl mx-auto px-6 py-24 w-full relative z-20">
          ...
          <h2 className="text-sm font-black text-gray-400 uppercase tracking-widest mb-10 text-center md:text-left">
            Nos Applications Disponibles
          </h2>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            
            {/* CARTE APPLICATION : GAINABLE PRO (OPTIMISÉE SEO) */}
            <a 
              href="https://gainablepro.atmo-pro.fr" 
              title="Découvrir GainablePro, notre logiciel de chiffrage de gainable"
              target="_blank" 
              ...
              <div className="bg-white rounded-[2rem] p-8 border border-gray-200 shadow-lg hover:shadow-2xl hover:border-[#29A5DB]/50 transition-all duration-300 h-full flex flex-col relative overflow-hidden">
                ...
                <div className="flex items-center gap-5 mb-8 mt-2">
                  ...
                  <div className="w-20 h-20 rounded-2xl bg-white flex items-center justify-center border border-gray-100 shadow-sm p-2 group-hover:scale-105 transition-transform overflow-hidden">
                    <img src="/logo-redimension-GP.png" alt="Logo GainablePro logiciel chiffrage" className="w-full h-full object-contain mix-blend-multiply" />
                  </div>
                  <div>
                    <h3 className="text-2xl font-black text-[#0E3A5F]">GainablePro</h3>
                ...
                <p className="text-gray-600 text-sm flex-1 font-medium leading-relaxed">
                  Le <strong>logiciel de chiffrage de gainable</strong> de référence et de conception aéraulique. Importez vos plans, tracez vos réseaux, et générez des nomenclatures constructeur infaillibles en un temps record.
                </p>
                
                <div className="mt-8 flex items-center text-[#0E3A5F] font-black text-sm group-hover:text-[#29A5DB] transition-colors leading-tight">
                  DÉCOUVRIR LE LOGICIEL DE CHIFFRAGE DE GAINABLE <span className="ml-3 group-hover:translate-x-2 transition-transform">→</span>
                </div>
              </div>
            </a>
            ...
            <div className="bg-white/40 rounded-[2rem] p-8 border-2 border-dashed border-gray-300 h-full flex flex-col justify-center items-center text-center opacity-80">
              ...
              <h3 className="text-xl font-black text-[#0E3A5F] mb-2">Module Plancher Chauffant</h3>
